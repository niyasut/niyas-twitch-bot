...
client.on('message', (channel, userstate, message, self) => {
  ...
  var msgsplit = message.split(' ').shift();


  if(msgsplit=="@niyasut"){
	 
      mentionrply(channel, userstate);
    return
 
}


	if(message.toLowerCase() === 'hello'||message.toLowerCase() === 'hi'||message.toLowerCase() === 'hy'||message.toLowerCase() === 'hii'||message.toLowerCase() === 'hiii'||message.toLowerCase() === 'HeyGuys') {
...
function mentionrply (channel, userstate) {
